            ...
            <div className="fullbg fullbgHOME dcontainer">
                <section className="sectionsT mUpL">
                    ...
                    >
                        ...
                        <p className="f1-5 mUpL">
                            <b className="hightText">RabinKarp Algorithm</b>
                            <ol className="ols mUpS f1-3">
                                <li>
                                It matches the hash value of the pattern with the hash value of current substring of text, and if the hash values match then only it starts matching individual characters.                                </li>
                            </ol>
                        </p>
                        <p className="f1-5 mUpL">
